...
#     sender_password = 'hhbknxxqpgloczhf'
...
st.title('Anaomaly detection app')
...
if choice == 'Upload':
    ...
    if st.button('Predict'):
        if video_file is not None:
            ...
            # send_email('Anomaly detected', f'Anomaly detected in the video. Class: {pred}, Probability: {prob}')
        else:
